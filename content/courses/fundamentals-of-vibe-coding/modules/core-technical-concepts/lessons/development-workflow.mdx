...
<LearningObjectives>
  <LearningObjective>Understand the basics of Git and GitHub for version control</LearningObjective>
  <LearningObjective>Learn the difference between development and production environments</LearningObjective>
  <LearningObjective>Master testing strategies with AI assistance</LearningObjective>
  <LearningObjective>Grasp CI/CD concepts for automated deployment</LearningObjective>
  <LearningObjective>Apply workflow best practices to Vibe Coding projects</LearningObjective>
</LearningObjectives>
...
### Git Mistakes
- **Large commits**: Making too many changes in a single commit
- **Poor commit messages**: Not explaining what and why changes were made
- **Working directly on main**: Making changes without creating branches
- **Forgetting to pull**: Not getting the latest changes before starting work

### Environment Confusion
- **Testing in production**: Making changes directly on live systems
- **No staging environment**: Skipping the testing phase before deployment
- **Environment-specific bugs**: Not testing in environments similar to production

### Testing Oversights
- **No automated tests**: Relying only on manual testing
- **Incomplete test coverage**: Not testing all critical functionality
- **Ignoring test failures**: Deploying even when tests fail
...
<LessonQuiz lessonId="fundamentals-of-vibe-coding-core-technical-concepts-development-workflow">
  <QuizQuestion question="What is the primary purpose of Git in software development?">
    <QuizOption>To write code faster</QuizOption>
    <QuizOption isCorrect>To track changes and enable collaboration</QuizOption>
    <QuizOption>To deploy applications automatically</QuizOption>
    <QuizOption>To test code for bugs</QuizOption>
  </QuizQuestion>
  
  <QuizQuestion question="Which environment should you use for testing new features?">
    <QuizOption>Production environment</QuizOption>
    <QuizOption isCorrect>Development environment</QuizOption>
    <QuizOption>Both environments equally</QuizOption>
    <QuizOption>Neither environment</QuizOption>
  </QuizQuestion>
  
  <QuizQuestion question="What does CI/CD stand for in software development?">
    <QuizOption>Code Integration and Code Deployment</QuizOption>
    <QuizOption isCorrect>Continuous Integration and Continuous Deployment</QuizOption>
    <QuizOption>Computer Interface and Computer Design</QuizOption>
    <QuizOption>Code Implementation and Code Development</QuizOption>
  </QuizQuestion>
</LessonQuiz>
