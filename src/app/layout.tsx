...
export const metadata: Metadata = {
  ...
  authors: [
    ...
    { name: "Dr. Ehoneah Obed", url: "https://github.com/ehoneahobed" },
  ],
  creator: "Project Vibe It Team",
  publisher: "Dr. Ehoneah Obed",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: siteConfig.url,
    title: "Project Vibe It - Master AI-Assisted Coding | Free Online Learning Platform",
    description: "Master AI-assisted coding with step-by-step lessons and hands-on projects. Learn web development, React, Next.js, and build real-world applications with AI tools. Completely free.",
    siteName: "Project Vibe It",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
